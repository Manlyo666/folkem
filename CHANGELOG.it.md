...
- Correzione: l'indicatore di furia offensiva ora usa un'icona fiamma (🔥) distinta dalla spada della scelta d'attacco, così non sembrano un simbolo doppio; il promemoria della scelta pre-evocazione è stato riposizionato per non coprire gli indicatori di furia/cura.
